...
public class SandboxRunner {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        sandbox(application, engine);
    }

    private static void sandbox(String application, Engine engine) throws IOException {
        // See please:
        ...
        final ApplicationService service = context.getBindings("java")
            ...
            .invokeMember("getApplication").as(ApplicationService.class);
        ...
        final ApplicationInfo newInfo = context.getBindings("java")
            ...
            .newInstance("sandboxed", "1.0.0").as(ApplicationInfo.class);
